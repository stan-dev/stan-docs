...
#knitr::include_graphics("./img/ppc-pois-pois.jpg")
```
![Posterior predictive checks for Poisson data generating process and Poisson model.](img/ppc-pois-pois.jpg)
...
```
![Posterior predictive checks for negative binomial data generating process and Poisson model.](img/ppc-nb-pois.jpg)
...
![Histogram of means of replicated data sets; vertical red line at mean of original data.](img/ppc-pvalue-nb-pois-mean.jpg)
...
![Scatterplot of standard deviations of replicated data sets; the vertical red line is at standard deviation of original data.](img/ppc-pvalue-nb-pois-sd.jpg)
